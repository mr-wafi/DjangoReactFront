...
class CustomerRequestComponentTest extends React.Component {
  constructor(props) {
    super(props);
  ...
  async fetchCustomerRequestData() {
    var apihandler = new APIHandler();
    var customerRequest = await apihandler.fetchAllCustomerRequest();
    console.log(customerRequest);
    this.setState({ CustomerRequestDataList: customerRequest.data.data });
  ...
  async CompleteCustomerRequestDetails(
    ...
    var apihandler = new APIHandler();
    var customerRequest = await apihandler.updateCustomerRequest(
      customer_id,
      name,
      phone,
      medicine_details,
...
export default CustomerRequestComponentTest;
