...
import AutoCompleteComponent from "../components/AutoCompleteMedicine";

class BillGenerateComponentTest extends React.Component {
  constructor(props) {
    super(props);
  ...
  RemoveMedicineDetails = () => {
    ...
    if (this.state.medicineDetails.length > 1) {
      ...
      // this down function also working but above method is you can choose length by your choice
                    ...
                    {this.state.medicineDetails.map((item, index) => (
                      <div className="row" key={index}>
                        <div className="col-lg-2">
                          <label htmlFor="name">SR No : </label>
                          <div className="form-group">
                            <div className="form-line">
                              <input
                                type="text"
...
export default BillGenerateComponentTest;
